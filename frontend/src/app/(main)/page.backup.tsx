...
export default function HomePage() {
    ...
    const cards = [
        { title: 'Thành viên gia phả', icon: TreePine, value: stats.people, desc: 'Trong cơ sở dữ liệu', href: '/pha-do' },
        { title: 'Dòng họ (families)', icon: Users, value: stats.families, desc: 'Gia đình đã ghi nhận', href: '/pha-do' },
        { title: 'Tài khoản', icon: Users, value: stats.profiles, desc: 'Người dùng đã đăng ký', href: '/danh-ba' },
        { title: 'Bài viết', icon: Newspaper, value: stats.posts, desc: 'Bảng tin dòng họ', href: '/feed' },
        { title: 'Sự kiện', icon: CalendarDays, value: stats.events, desc: 'Hoạt động sắp tới', href: '/su-kien' },
            ...
            <Card>
                ...
                <CardContent className="space-y-2">
                    <div className="flex flex-wrap gap-2">
                        <Link href="/pha-do"><Button variant="outline">🌳 Xem cây gia phả</Button></Link>
                        <Link href="/feed"><Button variant="outline">📰 Bảng tin</Button></Link>
                        <Link href="/su-kien"><Button variant="outline">📅 Sự kiện</Button></Link>
                        <Link href="/gia-pha"><Button variant="outline">📖 Sách gia phả</Button></Link>
                    </div>
                </CardContent>
            </Card>
        </div>
